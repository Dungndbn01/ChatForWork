...
//        let footer = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: footerId, for: indexPath) as! UICollectionReusableView
...
//        let user = MyObject.instance().user
...
//        userIdLabel = userIdLabel.setUpLabel(labelText: (user.chatId)!, textColor: .white, size: 12)
...
//
//        userIdLabel.anchor(nameLabel.bottomAnchor, left: self.view.leftAnchor, bottom: nil, right: self.view.rightAnchor, topConstant: 6, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 20)
//
...
//
//        userProfileTable.anchor(backgroundImageView.bottomAnchor, left: self.view.leftAnchor, bottom: self.view.bottomAnchor, right: self.view.rightAnchor, topConstant: 66, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 0)
//
